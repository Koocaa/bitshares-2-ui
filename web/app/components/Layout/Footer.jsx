...
class Footer extends React.Component {
    ...
    onBackup() {
        this.context.history.push("/wallet/backup/create");
    }

    onBackupBrainkey() {
        this.context.history.push("/wallet/backup/brainkey");
    }
}
...
class AltFooter extends Component {
    ...
    render() {
        ...
        return <AltContainer
            ...
            inject ={{
                backup_recommended: ()=> ! (!!WalletDb.getWallet() && !!WalletDb.getWallet().backup_date) || CachedPropertyStore.get("backup_recommended"),
